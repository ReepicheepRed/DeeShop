 ...
 **/
public class ViewFlowForScrollView extends ViewFlow {
    ...
    public ViewFlowForScrollView(Context context) {
        super(context);
        mSideBuffer = 3;
        init();
    }

    public ViewFlowForScrollView(Context context, int sideBuffer) {
        super(context);
        mSideBuffer = sideBuffer;
        init();
    }

    public ViewFlowForScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
